...
pub use shell::{ShellChatAction, ShellChatHandle, ShellState, ShellView, WorkspaceMode};
...
pub enum AppError {
    ...
    #[error("model catalog store error: {0}")]
    ModelCatalogStore(#[from] ModelCatalogStoreError),
}
